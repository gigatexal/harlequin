...
- The Query Editor now supports Vim-style modal editing, opening in insert mode for normal typing and entering normal, visual, or command mode with Vim keys.
